<template>
  <v-app :class="{ 'editor-container': isEditorRoute }">
    ...
    <v-navigation-drawer v-model="drawer" temporary class="mobile-nav">
      <v-list nav>
        <v-list-item
          v-for="item in items"
          :key="item.title"
    ...
    >
      <v-container
        class="d-flex align-center py-0 fill-height"
      ...
      >
        ...
        <div
          ...
          @click="$router.push('/')"
        >
          <img :src="require('@/assets/logo.png')" height="80" class="mr-3" />
        </div>
        ...
        <div
          v-if="fileName"
          class="text-h6 font-weight-medium text-grey-darken-3 text-truncate text-center mx-4"
